...
namespace Infra.Migrations
{
    ...
    [Migration("20231129114002_AddDistribution")]
            ...
            modelBuilder.Entity("Domain.Entities.Changes", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(5447));
            ...
            modelBuilder.Entity("Domain.Entities.DistributionGroup", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(5793));
            ...
            modelBuilder.Entity("Domain.Entities.DistributionRules", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(6252));
            ...
            modelBuilder.Entity("Domain.Entities.EarlyBird", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(5102));
            ...
            modelBuilder.Entity("Domain.Entities.Feature", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(4801));
            ...
            modelBuilder.Entity("Domain.Entities.Flag", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(4567));
            ...
            modelBuilder.Entity("Domain.Entities.Person", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(3854));
            ...
            modelBuilder.Entity("Domain.Entities.Profiles", b =>
                {
                    ...
                    b.Property<DateTime>("LastUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 8, 40, 2, 77, DateTimeKind.Local).AddTicks(4260));
